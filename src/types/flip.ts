...
type FlipOptions = {
  /**
   * When set to `1`, `t`, `true`, or boolean `true`, imgproxy will flip the image horizontally.
   * @default false
   */
  horizontal?: FlipBooleanValue;
  /**
   * When set to `1`, `t`, `true`, or boolean `true`, imgproxy will flip the image vertically.
   * @default false
   */
