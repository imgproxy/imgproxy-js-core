...
describe("ajust", () => {
  describe("test", () => {
    it("should return true if ajust option is defined", () => {
      expect(test({ ajust: {} })).toEqual(true);
    });
